...
pub fn save_lockfile(lockfile: &Lockfile) -> Result<()> {
...
pub fn save_lockfile_at(lockfile: &Lockfile, path: &Path) -> Result<()> {
    let header = "# This file is automatically @generated by Odyn.\n# Do not edit this file manually unless you know what you're doing.\n\n";
    let body = toml::to_string(lockfile)?;
...
pub fn gen_main_odin(name: impl Into<String>) -> String {
    let name = name.into();
    format!(
        "package main
